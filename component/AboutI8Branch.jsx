...
import clinicImage from "@/public/images/f8Images/f8slider2.webp"; // ✅ replace with your image path

export default function AboutI8Branch() {
  return (
    <section className="w-full bg-white py-12">
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center px-4">
        ...
        <div>
          ...
          <p data-aos="fade-down" className="text-gray-700 leading-relaxed mb-4">
          ...
          <p data-aos="fade-down" className="text-gray-700 leading-relaxed">
