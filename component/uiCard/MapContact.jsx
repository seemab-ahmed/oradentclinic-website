  ...
  <div>
    ...
    <p className="max-w-[500px] text-[#6B6A75]">{address}</p>
      ...
      <div className="mb-4 flex items-start gap-4">
        <Image src={Mail} alt="Email Icon" className="w-5 h-5 sm:w-8 sm:h-8 mt-1"/>
        <div>
      ...
      <div className="flex items-start gap-4">
        <Image src={Phone} alt="Phone Icon" className="w-6 h-6 sm:w-8 sm:h-8 mt-1" />
        <div>
